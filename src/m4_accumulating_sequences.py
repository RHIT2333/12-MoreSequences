...
def run_test_make_simple_list():
    ...
    actual = make_simple_list(6, 14)
    print('Expected:', expected)
    print('Actual:  ', actual)

    # Test 3:
    expected = [115, 116, 117, 118, 119, 120, 121, 122, 123]
    actual = make_simple_list(115, 123)
    print('Expected:', expected)
    print('Actual:  ', actual)

    # Test 4:
    expected = [50, 51, 52, 53, 54, 55, 56, 57, 58]
    actual = make_simple_list(50, 58)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_simple_string():
    ...
    # Test 2:
    expected = '2018-2019-'
    actual = make_simple_string(2018, 2019)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    # Test 2:
    expected = '2018-2019'
    actual = make_less_simple_string(2018, 2019)
    print('Expected:', expected)
    print('Actual:  ', actual)
